...
import sewing3 from "../../assets/images/sewing3.png";
import cutter3 from "../../assets/images/cutter3.png";
    ...
    <div className="backgroundbg">
      <div className="container-fluid">
        <div className="row">
          ...
          <div className="col-md-6 heading-section mt-4">
            <div className="row">
              <div className="col-md-12 d-flex justify-content-center align-items-center">
              ...
              <div className="col-md-12 d-flex justify-content-center align-items-center">
                <div className="row">
                  ...
                  <div className="col-md-6 text-center ctm-height custom-heading-image mt-2">
                    {" "}
                    <img
                      src={img2}
                      id="navbutton headinimage"
